<html>
    <body>
        <form action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post" enctype="multipart/form-data">
            ...
            <input onClick="document.location='../public/user-save-success.php'" type="submit" name="Save" value="Save"/>
            <input type="submit" name="Cancel" value="Cancel"/>            
        </form>      
		<br>	
		<p><button onClick="document.location='../public/user-list.php'">Return</button></p>
    </body>
</html>
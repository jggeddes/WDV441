...
<body>
	...
	<?php if($_SESSION['userlevel'] == "200" || $_SESSION['userlevel'] == "300") { ?>
		...
		<table style="width: 50%">
			...
			<h1>See All Users or Just One</h1>
			<p><button onClick="document.location='user-rest-list.php'">See all users</button></p>

			<p><button onClick="document.location='user-rest-view.php'">See 1 Users </button></p>
